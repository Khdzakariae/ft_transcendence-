...
export const acceptFriendRequest = async (request, reply) => {
  ...
  try {
    ...
    return reply
      .code(200)
      .send({ message: "Friend request accepted", data: { id: updated.id } });
  } catch (error) {
...
export const blockUser = async (request, reply) => {
  ...
  try {
    ...
    return reply
      .code(201)
      .send({ message: "User blocked", data: { id: blocked.id } });
  } catch (error) {
...
export const unblockUser = async (request, reply) => {
  ...
  try {
    ...
    if (res.count === 0)
      return reply.code(404).send({ error: "Blocked relation not found" });
