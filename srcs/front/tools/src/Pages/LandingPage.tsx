...
export function LandingPage(): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center mx-auto px-4">
        {/* Logo with Glow Effect */}
        <div className="relative mb-8 sm:mb-10 md:mb-12 animate-float">
          ...
          <img
            src={Logo}
            alt="Logo"
            className="relative w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 drop-shadow-2xl"
          />
        </div>

        {/* Main Heading with Gradient Text */}
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-primary font-extrabold leading-tight mb-6 animate-fadeInUp">
          <span className="block bg-gradient-to-r from-cyan-400 via-white to-cyan-400 bg-clip-text text-transparent drop-shadow-2xl mb-2">
            Ready to Play?
          </span>
        ...
        <div className="relative mb-10 sm:mb-12 md:mb-14">
          ...
          <p className="relative text-base sm:text-lg md:text-xl text-white font-secondary font-medium tracking-wide px-6 py-3 rounded-full border-2 border-white/20 bg-white/5 backdrop-blur-sm shadow-2xl animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
            Track stats • Connect with friends • Dominate the leaderboard
          </p>
        </div>

        {/* Buttons Container with Enhanced Layout */}
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 w-full max-w-md justify-center items-center animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
          <SecondaryButton
        ...
        <p className="mt-8 sm:mt-10 text-xs sm:text-sm text-gray-400 font-secondary tracking-widest uppercase animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
